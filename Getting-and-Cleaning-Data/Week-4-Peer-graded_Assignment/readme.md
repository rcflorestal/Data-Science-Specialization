...
### [run_analysis.R](https://github.com/rcflorestal/Data-Science-Specialization/blob/main/Getting-and-Cleaning-Data/Week-4-Peer-graded_Assignment/run_analysis.R) performs the data preparation to:
